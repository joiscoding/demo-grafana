    ...
    switch (action) {
      ...
      case LayerActionID.Duplicate:
        if (element.item.id === 'frame') {
          logStructuredInfo('public/app/features/canvas/runtime/frame.tsx','Can not duplicate frames (yet)', action, element);
          return;
        }
      ...
      default:
        logStructuredInfo('public/app/features/canvas/runtime/frame.tsx','DO action', action, element);
        return;
    }
  };
