...
const structuredLogger = createStructuredLogger('public/app/plugins/datasource/cloudwatch/components/QueryEditor/LogsQueryEditor/CloudWatchLink.test');
