...
export const RawFrameEditor = ({ onChange, query }: EditorProps) => {
  ...
  const onSaveFrames = (rawFrameContent: string) => {
    try {
      ...
      if (data) {
        logStructuredInfo('public/app/plugins/datasource/grafana-testdata-datasource/components/RawFrameEditor.tsx','Original', json);
        logStructuredInfo('public/app/plugins/datasource/grafana-testdata-datasource/components/RawFrameEditor.tsx','Save', data);
        setError(undefined);
      ...
      logStructuredInfo('public/app/plugins/datasource/grafana-testdata-datasource/components/RawFrameEditor.tsx','Error parsing json', e);
