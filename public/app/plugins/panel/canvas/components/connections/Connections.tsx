...
export class Connections {
  ...
  handleMouseEnter = (event: React.MouseEvent) => {
    ...
    if (!element) {
      logStructuredInfo('public/app/plugins/panel/canvas/components/connections/Connections.tsx','no element');
      return;
    }
    ...
    if (this.isDrawingConnection) {
      ...
      if (!this.connectionSource) {
        logStructuredInfo('public/app/plugins/panel/canvas/components/connections/Connections.tsx','no connection source');
        return;
      }
    }
