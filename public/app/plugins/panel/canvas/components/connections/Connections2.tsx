...
export class Connections2 {
  ...
  handleMouseEnter = (event: React.MouseEvent) => {
    ...
    if (!element) {
      logStructuredInfo('public/app/plugins/panel/canvas/components/connections/Connections2.tsx','no element');
      return;
    }
    ...
    if (this.isDrawingConnection) {
      ...
      if (!this.connectionSource) {
        logStructuredInfo('public/app/plugins/panel/canvas/components/connections/Connections2.tsx','no connection source');
        return;
      }
    }
